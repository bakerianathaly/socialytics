  ...
  protected getFollowerCount(){
    ...
    this.http.post(nodeAPI.toString(), info).subscribe((response: any) => {
      ...
      this.ChangeFollowersExcelData.push({ total: response.totalChangeFollowers,
        ...
        max: response.maxOfEachWeek,
        min: response.minOfEachWeek,
        SundayWeek1:response.week1[0],
        SundayWeek2:response.week2[0],
        SundayWeek3:response.week3[0],
        SundayWeek4:response.week4[0],
        MondayWeek1:response.week1[1],
        MondayWeek2:response.week2[1],
        MondayWeek3:response.week3[1],
        MondayWeek4:response.week4[1],
        TuesdayWeek1:response.week1[2],
        TuesdayWeek2:response.week2[2],
        TuesdayWeek3:response.week3[2],
        TuesdayWeek4:response.week4[2],
        WednesdayWeek1:response.week1[3],
        WednesdayWeek2:response.week2[3],
        WednesdayWeek3:response.week3[3],
        WednesdayWeek4:response.week4[3],
        ThursdayWeek1:response.week1[4],
        ThursdayWeek2:response.week2[4],
        ThursdayWeek3:response.week3[4],
        ThursdayWeek4:response.week4[4],
        FridayWeek1:response.week1[5],
        FridayWeek2:response.week2[5],
        FridayWeek3:response.week3[5],
        FridayWeek4:response.week4[5],
        SaturdayWeek1:response.week1[6],
        SaturdayWeek2:response.week2[6],
        SaturdayWeek3:response.week3[6],
        SaturdayWeek4:response.week4[6]
