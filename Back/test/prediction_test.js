...
describe("Probable amount of Reach per day of the week", () => {
    it("Probable amount of reach successfully", done =>{
        let register = {
            name: "Gianluigi",
            lastName: "Vincenzo",
            password: "12345678910",
    ...
    it("Fail probable amount of reach due to missing params in the request" , done =>{
        let data =[
            {
                value: 2,
                end_time: "2020-11-01T07:00:00+0000"
    ...
    it("Fail probable amount of reach due to unexistent user", done =>{
...
//Probable amount of Impressions tests

describe("Probable amount of Impressions per day of the week", () => {
    it("Probable amounnt of Impressions successfully", done =>{
        let register = {
            name: "vegeta",
            lastName: "sayayin",
            password: "12345678910",
        ...
        request(app).post('/signup').send(register).end((err, res) =>{
            ...
            let socialyticId = res.body.id
            let url = '/prediction/probableimpressions?socialyticId='+socialyticId+'&data='+data
    ...
    it("Fail probable amount of impressions due to missing params in the request" , done =>{
        let data =[
            {
                value: 2,
                end_time: "2020-11-01T07:00:00+0000"
    ...
    it("Fail probable amount of impressions due to unexistent user", done =>{
        
        let socialyticId = '5fa4c2f58a0772y6w52cb0e9'
        let fbToken = 'EAAV2pKo9RUke1vWV3YvgkCMgDaEZAjgZBHqdSHdmOE3d1OFZCxJSFDjVzskkhNSYZANHyTiDFW43riox4nfF7jjdONMCn2rIPzk3FiZA6ZBwC9petZBlQZDZD'
        let url = '/prediction/probableimpressions?socialyticId='+socialyticId+'&fbToken='+fbToken
