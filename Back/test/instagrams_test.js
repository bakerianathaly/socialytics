...
//Tests for top media posts

describe("Top 5 media post", () => {

    it("Top 5 media post successfully", done =>{

        let register = {
            name: "kiwito",
            lastName: "GB",
            password: "123456789101213",
            email: "DBSuper@gmail.com",
            industry: "Influencer"
        }
    ...
    it("Fail top media post due to missing params in the request", done =>{
        let info = {
            socialyticId: '5faec2f588ri4k56552cb0e9',
            media: ''
        }
    ...
    it("Fail top media post due to unexistent user", done =>{
        let info = {
            socialyticId: '5fae4kf588ri4k56552cb0e9',
            media : 'aksdkmk'
        }
